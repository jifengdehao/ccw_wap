      ...
      <div class="group-item-product">
        ...
        <ul class="item-img">
          <li>
            ...
            <img src="../../common/img/cart/select_selected_btn.png" alt="">
            <img src="../../common/img/cart/select_selected_btn.png" alt="">
            <div class="number" @click="onSeeProduct">共{{ num }}件 <span>&gt;</span></div>
          </li>
        </ul>
...
.group-item-product ul.item-img li .number { float: right; width: 50 / 20rem; line-height: 60 / 20rem; font-size: 12px; color: #666666; display: inline-block; text-align: center; }
